...
public class Examples {
	...
	public static void main(String[] args) {
		...
		System.out.println(j2.similarity("ABCDE", "BACDE"));
		System.out.println(j2.similarity("ABCDE", "ABXXX"));
		System.out.println(j2.similarity("ABCDE", "ABCD"));
		System.out.println(j2.similarity("My name is mridul", "My NAME is mridul"));
		System.out.println(j2.similarity("My name is mridul", "my name is mridul"));
		...
		// angle = 45°
		// => similarity = .71
		System.out.println(cos.similarity("ABCDE", "ABCDF"));
		System.out.println(cos.similarity("ABCDE", "BACDE"));
		System.out.println(cos.similarity("ABCDE", "ABXXX"));
		System.out.println(cos.similarity("ABCDE", "ABCD"));
		System.out.println(cos.similarity("Sanjay Naganathan", "sanjay reddy"));
		System.out.println(cos.similarity("My name is mridul", "my name is mridul"));
