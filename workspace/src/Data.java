...
public class Data implements Comparable {
     ...
     */
	public Data() {
		title = "NA"; volume = "NA"; pages = "NA"; year = 0; journal_booktitle = "NA";
	...
	public String getUrl() {
		try {
			StringBuilder temp = new StringBuilder(); temp.append(url.get(0));
			if (temp.toString() == null) {return "NA";}
			for (int i = 1; i < url.size(); i++) {temp.append(",");	temp.append(url.get(i));}
			return temp.toString();
